...
export default function FirstLayout({
  ...
  return (
    <main className=" max-w-screen-xl mt-[91px] px-4 mx-auto h-screen">
      <div className=" grid grid-cols-12">
        {/* first column */}
        
        <div className="  py-4 col-span-12 md:col-span-8">
        {children}
        </div>
        {/* second column */}
        <div className=" fixed left-[65.5%] z-40 bg-white/75 h-screen px-5 col-span-1 hidden md:block md:col-span-4 border-l border-bgdark">
